...
import { Display, Item } from '../../../Ifos/components/IfoCard/CardDetails/styles'
...
const Pairs: React.FC<any> = (props) => {
  ...
  return (
    <div>
      <Text margin="20px 10px">{t('Top Pairs')}</Text>
      <Container>
        <FiguresWrapper>
          <BodyWrapper>
            <Row>
              ...
              .map((tran: Transaction, index) => {
                return (
                  <Row key={tran.swaps[0].transaction.id} background={index % 2 === 0}>
                    <Column>
                      <img src={`/images/chains/${tran.chain}.png`} width="24px" />
