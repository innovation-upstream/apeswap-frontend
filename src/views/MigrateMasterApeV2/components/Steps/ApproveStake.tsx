...
const ApproveStake: React.FC<{ apeswapWalletLps: MasterApeV2ProductsInterface[] }> = ({ apeswapWalletLps }) => {
  ...
  const listView = useMemo(() => {
    return filteredLpsForStake?.map(({ walletBalance, lp, farm, vault, id, singleStakeAsset }) => {
  ...
  }, [filteredLpsForStake, isMobile, migrateMaximizers, migrateLpStatus, t])
